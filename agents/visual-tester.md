...
After writing the visual test report, exit cleanly.

**Do NOT:**
- Re-read the report you just wrote
- Take additional screenshots or run more tests
- Run cleanup commands (the parent agent handles browser state)
